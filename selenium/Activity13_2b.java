//Activity:13.2b
//In this activity, read from Excel file and fill in form.
//
//    Read data from the Excel file in the previous activity.
...
public class Activity13_2b {
    ...
    public static void main(String[] args) {
        ...
        String filePath = "src/SeleniumActivities/Activity13_2a.xlsx";
